...
public class Example_Motion_Attack_Shield_Controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isdead == false)
        {
            ...
            if (shield_mode == true)
            {//If shield_mode is activated and key up right mouse button, shield_mode=off
            ...
            {//----------!!!!!!!!!!!!If shield_mode is activated, the character can not walk and jump but he can dead.!!!!!!!!!!
                if (Input.GetMouseButtonDown(1))
                {//If shield_mode is deactivated and key down right mouse button, shield_mode=on
